...
В нашей лекции SMT не используется — таблица и payload сделаны под друг друга. SMT всплывут позже: полное погружение в use case [Postgres → ClickHouse с анонимизацией](../../09-use-cases/03-pg-to-clickhouse/README.md), там они нужны для outbox event router.
