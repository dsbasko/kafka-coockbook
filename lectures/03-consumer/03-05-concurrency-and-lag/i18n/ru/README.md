...
**Hot key.** Если один ключ активнее всех других — его worker станет узким местом, остальные будут простаивать. Симптом — lag растёт, а CPU на 90% свободен. Лечится composite key (см. runbook [Troubleshooting runbook](../../../../08-operations/08-04-troubleshooting-runbook/i18n/ru/README.md)) или per-record sharding c sub-key'ями.
