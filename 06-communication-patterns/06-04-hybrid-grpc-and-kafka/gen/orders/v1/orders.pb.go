...
const file_orders_v1_orders_proto_rawDesc = "" +
	...
	"\vGetResponse\x12&\n" +
	"\x05order\x18\x01 \x01(\v2\x10.orders.v1.OrderR\x05order*\xa9\x01\n" +
	...
	"\x16ORDER_STATUS_CANCELLED\x10\x052O\n" +
	"\x0eCommandService\x12=\n" +
	"\x06Create\x12\x18.orders.v1.CreateRequest\x1a\x19.orders.v1.CreateResponse2D\n" +
	"\fQueryService\x124\n" +
	"\x03Get\x12\x15.orders.v1.GetRequest\x1a\x16.orders.v1.GetResponseBxZvgithub.com/dsbasko/kafka-sandbox/lectures/06-communication-patterns/06-04-hybrid-grpc-and-kafka/gen/orders/v1;ordersv1b\x06proto3"
...
var file_orders_v1_orders_proto_depIdxs = []int32{
	...
	2, // 4: orders.v1.CommandService.Create:input_type -> orders.v1.CreateRequest
	4, // 5: orders.v1.QueryService.Get:input_type -> orders.v1.GetRequest
	3, // 6: orders.v1.CommandService.Create:output_type -> orders.v1.CreateResponse
	5, // 7: orders.v1.QueryService.Get:output_type -> orders.v1.GetResponse
